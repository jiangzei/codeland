...
　　邹琪于2018年2月26日创建本模块，email: qzou@bjtu.edu.cn
   ...
   吴林江于2022年3月10日修改本模块，作实验用途，更正了程序错误  email：21281141@bjtu.edu.cn
**********************************************************/
...
*返回值：1表示是鞍点；0表示不是鞍点
*版本信息：create by hansheng,2018-10-28
         bettered by 吴林江，2022-03-10（Add annotation）
*/
...
*返回值：无
*版本信息：create by hansheng,2018-10-28
         bettered by 吴林江，2022-03-10（Process Optimization & Error Correction）
*/
void work()
{
    int i,j;
